...
@Composable
fun GestionProfesoresScreen( navigateToInit: () -> Unit,
                          navigateBack: () -> Unit
                          ) {
    ...
    ModalNavigationDrawer(
        ...
        drawerContent = {
            Column(
                modifier = Modifier
                    .fillMaxHeight()
                    .width(200.dp)
                    .background(colorResource(id = R.color.colorProfesor))
            ) {
        ...
        Scaffold(
            ...
            bottomBar = {
                NavigationBar(
                    containerColor = colorResource(id = R.color.colorProfesor) // Colores de fondo
                ) {
                    NavigationBarItem(
                        selected = false,
                        onClick = {
