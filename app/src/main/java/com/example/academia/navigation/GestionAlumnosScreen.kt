...
@Composable
fun GestionAlumnosScreen( navigateToInit: () -> Unit,
                          navigateBack: () -> Unit
                          ) {
    ...
    ModalNavigationDrawer(
        ...
        drawerContent = {
            Column(
                modifier = Modifier
                    .fillMaxHeight()
                    .width(200.dp)
                    .background(colorResource(id = R.color.colorAlumno))
            ) {
        ...
        Scaffold(
            ...
            bottomBar = {
                NavigationBar(
                    containerColor = colorResource(id = R.color.colorAlumno) // Colores de fondo
                ) {
                    NavigationBarItem(
                        selected = false,
                        onClick = {
            ...
            Box(
                ...
                // Aquí puedes añadir el contenido principal de la pantalla
            }
        }
    }
}
...
fun DrawerItem(text: String) {
    Text(
        ...
        modifier = Modifier
            .fillMaxWidth()
            .clickable { /* Acción de navegación */ }
            .padding(18.dp),
